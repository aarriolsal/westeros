...
import { POINTS_SERIE, POINTS_LIBROS, ALL_POINT } from '../../data/progress'
    ...
    <AnimatePresence>
      {progOpen && (
        <motion.div
          ...
          aria-label="Selector de punto de la saga"
        >
          {/* Panel header */}
          <div
            style={{
