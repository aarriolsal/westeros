...
export const REGIONS_GEOJSON_URL = `${import.meta.env.BASE_URL}data/map/regions.geojson`
export const PLACES_GEOJSON_URL = `${import.meta.env.BASE_URL}data/map/places.geojson`
